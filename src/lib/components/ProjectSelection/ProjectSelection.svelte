<script>
    import Header from "$lib/components/ProjectSelection/Header.svelte"
...
<div class={`
    ...
    <div class="grow-1">
        ...
        <div class="projectsContainer
            ...
            <div class="flex justify-around items-center flex-wrap gap-0 md:gap-5">
